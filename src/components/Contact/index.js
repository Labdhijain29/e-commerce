...
const Contact = () => {
  return (
    <Link to={"/contact"} id="contact" class="text-gray-600 body-font relative">
    ...
    <div class="container px-5 py-24 mx-auto flex">
      <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
        ...
        <p class="leading-relaxed mb-5 text-gray-600">We’d love to hear from you! Share your thoughts and feedback below.</p>
        ...
        <p class="text-xs text-gray-500 mt-3">Your feedback helps us improve our services.</p>
      </div>
    </div>
  </Link>
