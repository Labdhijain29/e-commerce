...
const Product = () => {
    ...
    const handleCart = (product, redirect) => {
        ...
        const isProductExsit = cart.find(item => item.id === product.id)
        if (isProductExsit) {
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex mb-4">
                            <span className="flex items-center">
                                ...
                                <span className="text-gray-600 ml-3">{product?.review}</span>
                            </span>
                        ...
                        <div className="flex">
                            ...
                            <div className='flex justify-between items-center mt-20'>
                                <button className="flex ml-auto text-white mr-2 bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={() => handleCart(product, true)}>Buy It Now</button>
